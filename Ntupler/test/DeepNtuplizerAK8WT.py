...
options.outputFile = 'output_WT.root'
...
options.register('addLowLevel', False, VarParsing.multiplicity.singleton, VarParsing.varType.bool, "add low-level vars to output file")
options.register('isMDTagger', False, VarParsing.multiplicity.singleton, VarParsing.varType.bool, "use MD tagger categorisation")
...
globalTagMap = {
    '23' : '150X_mcRun3_2023_realistic_v1',
}
era = '23'
