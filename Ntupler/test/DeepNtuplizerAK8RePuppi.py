...
# !!! set `doCustomTaggerInference = True` to infer custom taggers and get their scores (default: False) !!!
doCustomTaggerInference = False


# apply the new puppi tune
assert useReclusteredJets == True, 'This script is dedicated to use reclustered jets. Set useReclusteredJets=True to proceed.'
...
if doCustomTaggerInference:
    ...
    # add custom btag discriminators using custom updateJetCollection
    updateJetCollection(
        process,
